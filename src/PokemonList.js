// List is taken from PokéAPI to reduce the amount of API calls
// Hopefully it's ok to do so, I have no intention to redistribute the data and claim credit for it
// https://pokeapi.co/
...
function getNames() {
    ...
    pokemonListObj.results.map((index) => {
      return  pokemonNameArr.push(index.name);
    })

    return pokemonNameArr;
}

const pokemonNamesArr = getNames();

export default pokemonNamesArr;